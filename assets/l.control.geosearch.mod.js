...
L.Control.GeoSearch = L.Control.extend({
    ...
    _config: {
        country: '',
        searchLabel: 'Enter Newark address ...',
...
//        zoomLevel: 18
    ...
    onAdd: function (map) {
        ...
        inputspan.className = 'btn-span';
        inputspan.placeholder = this._config.searchLabel;
        this._inputspan = inputspan;
        ...
        this._container.appendChild(this._inputspan);
                this._container.appendChild(this._inputbtn);
        ...
        L.DomEvent
          ...
          .addListener(this._inputbtn, 'click', this._onClick, this);
